...
namespace UeFGame.GameObjects.Player
{
    ...
    public class AnimationStateNode
    {
        ...
        /// <returns></returns>
        public delegate bool AnimationStatePredicate(GameEvent evt, int frame);
        /// <summary>
        ...
        /// </summary>
        public AnimationStateNode(PlayerAnimationState state)
        {
    ...
    public class AnimationStateManager
    {
        ...
        {
            AnimationStateNode idle = new AnimationStateNode(PlayerAnimationState.Idle);
            AnimationStateNode running = new AnimationStateNode(PlayerAnimationState.Running);
            ...
            idle.Predicates.Add(new AnimationStateNode.AnimationStatePredicate(delegate(GameEvent evt, int frame)
            {
                return true;
            }));
            // Idle -> Running
        ...
        public void Update(GameEvent evt)
        {
            ...
            PlayerAnimationState oldAnimState = CurrentState;
            m_currentNode = newNode;
            PlayerAnimationState newAnimState = CurrentState;
