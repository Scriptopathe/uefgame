...
namespace FarseerPhysics.Dynamics
{
    ...
    public enum Category
    {
        ...
        Object = 1,
        /// <summary>
        /// Indicates the Body can be shot.
        /// </summary>
        Shootable = 2,
        /// <summary>
        /// Indicates the Body belongs to a Particle.
        /// </summary>
        Particle = 4,
        /// <summary>
        /// Indicates the Body belongs to player.
        /// </summary>
        Player = 8,
        /// <summary>
        /// Indicates the Body belongs to a friend of the player
        /// </summary>
        Friend = 16,
        /// <summary>
        /// Indicates the Body belongs to an Ennemy.
        /// </summary>
        Ennemy = 32,
        /// <summary>
        /// Indicates the Body belongs to the Ground.
        /// </summary>
        Ground = 64,
        /// <summary>
        /// Indicates the Body belongs to a shoot.
        /// </summary>
        Shoot = 128,
        Cat9 = 256,
        Cat10 = 512,
    ...
    public class Fixture : IDisposable
    {
        ...
        public Fixture(Body body, Shape shape, object userData)
        {
            if (Settings.UseFPECollisionCategories)
                ...
                _collisionCategories = Category.Object;
